...
python local_viewer.py --model-path  output/human/neuman/lab/hugs_wo_trimlp/20240303_2145_abl_trimlp-dataset.seq=citron/2024-05-14_13-20-17-45k-complete --point-path point_cloud/iteration_1000/point_cloud.ply --orbit-path /home/mizeller/projects/experiments/ml-hugs/scripts/ellipse_orbit.npy
