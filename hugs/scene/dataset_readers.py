...
from hugs.scene.colmap_loader import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, \
    read_extrinsics_binary, read_intrinsics_binary, read_points3D_binary, read_points3D_text
from hugs.utils.graphics_utils import getWorld2View2, focal2fov, fov2focal
import numpy as np
import json
from pathlib import Path
from plyfile import PlyData, PlyElement
from hugs.utils.sh_utils import SH2RGB
from hugs.scene.gaussian_model import BasicPointCloud
...
def fetchPly(path):
    ...
    return BasicPointCloud(points=positions, colors=colors, normals=normals, faces=None)
...
def readNeumanSceneInfo(path, images: str = "images", eval: bool = False, llffhold: int = 8): #  path, white_background, eval, extension=".png"):
...
sceneLoadTypeCallbacks = {
    "HUGS": readNeumanSceneInfo, # adapter to extract all necessary information from NeumanDataset into a SceneInfo object
